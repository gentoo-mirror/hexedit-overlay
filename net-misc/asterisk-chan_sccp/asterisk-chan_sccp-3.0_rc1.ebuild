...
IUSE="+pickup +park +dirtrfr +monitor conference +manager +functions indications +realtime feature-monitor advanced-functions dynamic-speeddial debug static"
